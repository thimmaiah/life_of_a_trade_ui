(function () {
    ...
    angular.module('app.customer').controller('CustomersSearchCtrl',
			CustomersSearchCtrl);

	CustomersSearchCtrl.$inject = [ '$scope', '$location', '$filter', 'Customer'];
	
	function CustomersSearchCtrl($scope, $location, $filter, Customer) {
		
		var vm = this;
		
		vm.search = function(term) {
			return $scope.search_securities = Customer.search({
				term : term
