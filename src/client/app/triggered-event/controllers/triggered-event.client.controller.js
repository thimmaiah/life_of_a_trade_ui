(function () {
    ...
    angular
        ...
        .controller('TriggeredEventController', TriggeredEventController);

    TriggeredEventController.$inject = ['logger',
        '$stateParams',
        '$state',
        'TriggeredEvent',
        'TableSettings',
        'TriggeredEventForm'];
    /* @ngInject */
    function TriggeredEventController(logger,
        $stateParams,
        $state,
        TriggeredEvent,
        TableSettings,
        ...
        // See http://angular-formly.com/ and services/triggered-event.form.client.service.js and views/create.html
        ...
        vm.remove = function(triggeredEvent) {
            ...
            if (triggeredEvent) {
                triggeredEvent = TriggeredEvent.get({triggeredEventId:triggeredEvent.id}, function() {
        ...
        vm.toViewTriggeredEvent = function() {
            vm.triggeredEvent = TriggeredEvent.get({triggeredEventId: $stateParams.triggeredEventId}, vm.successResponse, vm.errorResponse);
