...
angular.module('app.vendor').config(['$stateProvider','$urlRouterProvider', '$controllerProvider', '$compileProvider', '$filterProvider', '$provide', '$ocLazyLoadProvider', 'APP_REQUIRES',
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, appRequires) {
  ...
  angular.module('app.vendor').controller = $controllerProvider.register;
  angular.module('app.vendor').directive  = $compileProvider.directive;
  angular.module('app.vendor').filter     = $filterProvider.register;
  angular.module('app.vendor').factory    = $provide.factory;
  angular.module('app.vendor').service    = $provide.service;
  angular.module('app.vendor').constant   = $provide.constant;
  angular.module('app.vendor').value      = $provide.value;
  ...
  $stateProvider
    ...
    .state('app.recover', {
        url: '/recover',
        title: "Recover",
        templateUrl: 'app/templates/pages/recover.html'
    })
    .state('app.logout', {
        url: '/logout',
        title: 'Logout',
        templateUrl: basepath('lock.html'),
        controller: 'LoginController'
    })
    .state('app.postRegistration', {
        url: '/post_registration',
        title: 'Registration Complete - Next Steps',
        templateUrl: basepath('post_registration.html'),
        controller: 'LoginController'
    })
    .state('app.dashboard', {
        url: '/dashboard',
    ...
    .state('page', {
        url: '/page',
        templateUrl: 'app/templates/pages/page.html',
    ...
    .state('page.register', {
        url: '/register',
        title: "Register",
        templateUrl: 'app/templates/pages/register.html'
    })    
    .state('page.lock', {
        url: '/lock',
        title: "Lock",
        templateUrl: 'app/templates/views/lock.html'
    })
    ;
    ...
    function basepath(uri) {
      return 'app/templates/views/' + uri;
    }
